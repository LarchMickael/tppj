			...
			<fieldset>
				<div id="fieldsetDiv" >
					...
					<span>
						...
						<input id="firstname" name="use_firstname" type="text">
					</span>
					<span>
						<label class="inscriptionLabel" for="lastname"><?php echo $content['inscription_lastname_label']; ?></label>
						<input id="lastname" name="use_lastname" type="text">
					</span>
				</div>
			</fieldset>
